...
public class CarRentalCompany {
    ...
    //Een CRC haaft verschillende CarTypes en een CartType kan bij verschillende crc horen
    @ManyToMany
    public Collection<CarType> getAllTypes() {
        return carTypes;
    }

    //TODO moet deze annotation altijd gezet worden als andere entity gevraagd wordt?
    @ManyToMany
    ...
    //Een crc heeft meerdere cars, maar een car hoort maar bij een crc
    ...
    //TODO moet dit hier of moet er een nieuwe getter voor reservation gemaakt worden?
    @OneToMany(cascade=REMOVE, mappedBy="carrentalcompany")
    ...
    //TODO getters maken voor car-cartype-reservation
    //TODO ook setters maken
